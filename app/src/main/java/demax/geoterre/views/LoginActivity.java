...
import demax.geoterre.application.network.LoginLoader;
import demax.geoterre.application.network.ParcelleLoader;
import demax.geoterre.application.network.RequestCallback;
import demax.geoterre.application.network.NetworkConnection;
import demax.geoterre.application.network.Request;
import demax.geoterre.application.network.Response;
import demax.geoterre.application.network.SimpleCallback;
...
//           this.connect();
        ...
        mEmailView.setText("maxime.maillet93@gmail.com");
        mPasswordView = (EditText) findViewById(R.id.password);
        mPasswordView.setText("21022102");
        /*
    ...
    public void connect()
    {
        ParcelleLoader pcLoad = new ParcelleLoader(getApplicationContext());
        pcLoad.setCallback(new SimpleCallback() {
            @Override
            public void call() {
                startActivity(new Intent(LoginActivity.this, MapsMainActivity.class));
            }
        });
